...
public class TicketController {
    ...
    public TicketController() {
        TICKETS.add(new Ticket(1L, "Pink", LocalDate.of(2025, 9, 3), "Phnom Penh", "SR", 111.0, true, TicketStatus.CANCELLED, 16));
        TICKETS.add(new Ticket(2L, "melonn", LocalDate.of(2023, 6, 1), "Phnom Penh", "SR", 199.0, false, TicketStatus.BOOKED, 19));
        TICKETS.add(new Ticket(3L, "lemon", LocalDate.of(2019, 9, 5), "Phnom Penh", "SR", 188.0, true, TicketStatus.CANCELLED, 17));
    ...
    public ResponseEntity<Response<List<Ticket>>> getAllTickets(
        ...
        return ResponseEntity.ok(new Response<>(true, "Tickets retrieved success", HttpStatus.OK, shownTickets));
    }
    ...
    public ResponseEntity<Response<Ticket>> updateTicketById(
        ...
        for (Ticket ticket : TICKETS) {
            if (ticket.getTicketId().equals(ticketId)) {
                ...
                return ResponseEntity.ok(new Response<>(true, "Ticket updated success", HttpStatus.OK, ticket));
            }
        }
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new Response<>(false, "Ticket not found", HttpStatus.NOT_FOUND, null));
